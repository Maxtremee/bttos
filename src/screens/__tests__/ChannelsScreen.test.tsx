...
vi.mock("../../navigation", () => ({
  ...
  Focusable: (props: {
    ...
    return (
      typeof props.children === "function" ? props.children(bag) : props.children
    ) as JSX.Element;
  },
}));
...
vi.mock("../../services/TwitchChannelService", () => ({
  twitchChannelService: {
    get fetchLiveFollowedChannels() {
      return mockFetchLiveFollowedChannels;
    },
  },
}));
...
describe("ChannelsScreen", () => {
  ...
  it("calls clearInterval with the timer ID on unmount", async () => {
    ...
    vi.spyOn(globalThis, "setInterval").mockReturnValue(
      mockTimerId as unknown as ReturnType<typeof setInterval>,
    );
